...
import (
	...
	config "github.com/MateusMoutinhoOrg/Verb/sandbox/internal/config"
)
...
// NewInfo builds the api.Info contract, running every factory over it to fill
// its function fields. Adding a function field to api.Info means adding its
// factory call here.
